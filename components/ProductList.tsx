 ...
 * Displays the live inventory in a searchable list format.
 * Features include dynamic status badges and access to Edit/Delete actions.
 */
export default function ProductList({ products }: { products: any[] }) {
  const [search, setSearch] = useState("");
  /**
   * Client-Side Search Logic
   * Filters the products array based on whether the product name contains the search string.
   * Both are converted to lowercase to ensure the search is case-insensitive.
   */
            ...
            >
              ...
              <div className="flex items-center gap-6">
                <div className="text-right">
                  ...
                  {/* Status Badge: Toggles between Active and Low Stock */}
                  {product.stock < 5 ? (
                ...
                <div className="flex items-center gap-2">
                   ...
                   {/* Reusable Client Component for Deletion logic */}
